...
console.log(`  score  : ${result.score.total}   [ending ${result.score.endingPoints} | survival ${result.score.survival} | governance ${result.score.governance} | debt -${result.score.debtPenalty}]`);
