...
console.log(`  score  : ${result.score.total}   [ending ${result.score.endingPoints} | survival ${result.score.survival} | governance ${result.score.governance} | audit ${result.score.auditability} | debt -${result.score.debtPenalty}]`);
